...
export default function Testimonials() {
  return (
    // <Container>
    <section id="revs"  className="min-w-screen min-h-screen bg-white flex items-center justify-center py-5">
      <div className="w-full bg-white px-5 py-16 md:py-24 ">
        <div className="w-full max-w-6xl mx-auto">
          <div className="text-center max-w-full mx-auto">
            <p className="font-medium text-indigo-500">Reseñas</p>
            <h1 className="text-2xl font-semibold text-gray-800 md:text-3xl">Qué piensan de nuestros productos y servicios?</h1>
            <p className="mb-5 mt-3 text-gray-500">Contamos con una larga variedad de opiniones y reseñas positivas.</p>
            <div className="text-center mb-10">
              <span className="inline-block w-1 h-1 rounded-full bg-indigo-600 ml-1"></span>
              <span className="inline-block w-3 h-1 rounded-full bg-indigo-600 ml-1"></span>
              <span className="inline-block w-40 h-1 rounded-full bg-indigo-600"></span>
              <span className="inline-block w-3 h-1 rounded-full bg-indigo-600 ml-1"></span>
              <span className="inline-block w-1 h-1 rounded-full bg-indigo-600 ml-1"></span>
            </div>
          </div>
            ...
            <div className="px-3 md:w-1/3">
              <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                <div className="w-full flex mb-4 items-center">
                  <div className="overflow-hidden rounded-full w-10 h-10 bg-gray-50 border border-gray-200">
                    {/* <Image width={} src="./hero.jpg" alt=""> */}
                  </div>
                  <div className="flex-grow pl-3">
                    <h6 className="font-bold text-sm uppercase text-gray-600">Ritchie Kindergaten.</h6>
                  </div>
                </div>
              ...
              <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                <div className="w-full flex mb-4 items-center">
                  ...
                  <div className="flex-grow pl-3">
                    <h6 className="font-bold text-sm uppercase text-gray-600">Institución Nombre.</h6>
                  </div>
                </div>
                <div className="w-full">
